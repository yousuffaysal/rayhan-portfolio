...
export default function SocialStrip() {
  return (
    <div className="sf-strip">
      <motion.div className="sf-left" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
        <div className="sf-title">Find me on the web</div>
        <div className="sf-sub">Let&rsquo;s stay connected across platforms</div>
      </motion.div>
      <motion.div className="sf-links" variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }}>
        {socials.map((s, i) => (
          <motion.a
            key={s.label}
            href={s.href}
